...
Report bugs at https://github.com/pcdshub/nabs/issues.
...
nabs could always use more documentation, whether
as part of the official nabs docs, in docstrings,
or even on the web in blog posts, articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/pcdshub/nabs/issues.
...
Ready to contribute? Here's how to set up `nabs` for local development.

1. Fork the `nabs` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/nabs.git
...
3. Install your local copy into a new conda environment. Assuming you have conda installed, this is how you set up your fork for local development::
    ...
    $ conda create -n nabs python=3.9 pip
    $ cd nabs/
    $ pip install -e .
